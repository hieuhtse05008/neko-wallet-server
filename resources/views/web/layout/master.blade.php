            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <div class="ms-auto d-flex">
                        <div class="dropdown">
                            <div class="btn btn-sm rounded btn-main py-2 px-3 dropdown-toggle me-2" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                {{ strtoupper($locale) }}
                            </div>
            ...
            <div id="footer-wrap" class=" py-5">
                <div class="row py-0 py-sm-5">
                    ...
                    <div class="col-md-3 col-6 mb-5 text-white">
                        ...
                        <div class="mb-sm-0"><a class="pointer" data-bs-toggle="modal" data-bs-target="#modal-check-my-spot">Check my spot</a></div>
                    </div>
