...
/**
 * Class RefBlogGroupApiTest
 * @package Tests\APIs
 */
class RefBlogGroupApiTest extends TestCase
{
    private $response;
    ...
    public function assertApiResponse(Array $actualData)
    {
        ...
        $responseData = $response['ref_blog_group'];
     ...
     public function assertApiResponseListData()
    {
        ...
        $response = json_decode($this->response->getContent(), true);
        $responseData = $response['ref_blog_groups'];
    ...
    public function test_create_ref_blog_group()
    {
        ...
        $this->response = $this->withHeaders([
            ...
            'POST',
            '/api/v1/ref-blog-groups', $refBlogGroup
        );

        $this->assertApiResponse($refBlogGroup);
    }

    /**
     * @test
     */
    public function test_list_ref_blog_group()
    {
    ...
    public function test_read_ref_blog_group()
    {
        ...
        $this->response = $this->withHeaders([
            ...
            'GET',
            '/api/v1/ref-blog-groups/'.$refBlogGroup->id
        );

        $this->assertApiResponse($refBlogGroup->toArray());
    }
    ...
    {
        $refBlogGroup = RefBlogGroup::factory()->create();
        $editedRefBlogGroup = RefBlogGroup::factory()->make()->toArray();
        ...
        $this->assertApiResponse($editedRefBlogGroup);
    }
